...
namespace Автоматизированная_Система_Стипендии {
    ...
    public partial class АС_СтипендииDataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/АС_СтипендииDataSet31.xsd";
...
namespace Автоматизированная_Система_Стипендии.АС_СтипендииDataSet3TableAdapters {
    ...
    public partial class СтудентыTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Студенты` WHERE ((`IDстудента` = ?) AND ((? = 1 AND `Фамилия` IS NUL" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Студенты` SET `Фамилия` = ?, `Имя` = ?, `Отчество` = ? WHERE ((`IDстудент" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDстудента, Фамилия, Имя, Отчество FROM Студенты";
        ...
        public virtual int Delete(int Original_IDстудента, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, int Original_IDстудента, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
            if ((Фамилия == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_IDстудента));
            if ((Original_Фамилия == null)) {
