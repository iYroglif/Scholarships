...
namespace Автоматизированная_Система_Стипендии {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("АС_СтипендииDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class АС_СтипендииDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected АС_СтипендииDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            АС_СтипендииDataSet cln = ((АС_СтипендииDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "АС_СтипендииDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/АС_СтипендииDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            АС_СтипендииDataSet ds = new АС_СтипендииDataSet();
        ...
        public partial class СтудентыDataTable : global::System.Data.TypedTableBase<СтудентыRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public СтудентыRow AddСтудентыRow(string Фамилия, string Имя, string Отчество) {
...
namespace Автоматизированная_Система_Стипендии.АС_СтипендииDataSetTableAdapters {
    ...
    public partial class СтудентыTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Студенты` WHERE ((`ID студента` = ?) AND ((? = 1 AND `Фамилия` IS NU" +
                "LL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Студенты` (`Фамилия`, `Имя`, `Отчество`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Студенты` SET `Фамилия` = ?, `Имя` = ?, `Отчество` = ? WHERE ((`ID студен" +
                "та` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND " +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [ID студента], Фамилия, Имя, Отчество FROM Студенты";
        ...
        public virtual int Fill(АС_СтипендииDataSet.СтудентыDataTable dataTable) {
        ...
        public virtual АС_СтипендииDataSet.СтудентыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            АС_СтипендииDataSet.СтудентыDataTable dataTable = new АС_СтипендииDataSet.СтудентыDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(АС_СтипендииDataSet.СтудентыDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(АС_СтипендииDataSet dataSet) {
        ...
        public virtual int Delete(int Original_ID_студента, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, int Original_ID_студента, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
            if ((Фамилия == null)) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(АС_СтипендииDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._студентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(АС_СтипендииDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._студентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(АС_СтипендииDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._студентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(АС_СтипендииDataSet dataSet) {
            if ((dataSet == null)) {
